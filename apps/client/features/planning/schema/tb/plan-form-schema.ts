...
export const createEmptyActivity = (
  ...
  // Required fields - start with undefined, validation only on submit
  frequency: undefined,
  unitCost: undefined,
  
  // Quarter count - start with 0 as per schema defaults
  countQ1: 0,
  countQ2: 0,
  countQ3: 0,
  countQ4: 0,
  
  // Calculated field - always 0 initially
  amountQ1: 0,
  amountQ2: 0,
  amountQ3: 0,
  amountQ4: 0,
...
// Calculate total budget for an activity (TB can use all quarters)
